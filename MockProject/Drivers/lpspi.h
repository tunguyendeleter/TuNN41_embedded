...
extern void LPSPI_ConfigMaster(LPSPI_TypeDef *pLPSPIx);
extern void LPSPI_ConfigSlave(LPSPI_TypeDef *pLPSPIx);
extern void LPSPI_Transmit(LPSPI_TypeDef *pLPSPIx, uint16 sendData);
extern uint16 LPSPI_Receive(LPSPI_TypeDef *pLPSPIx);

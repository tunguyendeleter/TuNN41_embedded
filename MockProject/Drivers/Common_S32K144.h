...
/**
* @brief    Define base address of LPSPI module
*/
...
/**
 * @brief  Define structure pointer to SCG registers
 */
#define SCG                     ((SCG_TypeDef*) SCG_BASE)

/**
 * @brief  Define structure pointer to ADC registers
 */
#define ADC0                    ((ADC_TypeDef*) ADC0_BASE)
#define ADC1                    ((ADC_TypeDef*) ADC1_BASE)

/**
 * @brief  Define structure pointer to LPSPI registers
 */
...
typedef struct 
{
    ...
    volatile uint32 PCC_LPSPI0;                /* PCC LPSPI0 Register, OFFSET = B0h*/    
    volatile uint32 PCC_LPSPI1;                /* PCC LPSPI1 Register, OFFSET = B4h*/   
    volatile uint32 PCC_LPSPI2;                /* PCC LPSPI2 Register, OFFSET = B8h*/   
    uint32 reserve3[2];            
...
/**
* @brief  Define structure of LPSPI typedef
*/
typedef struct {

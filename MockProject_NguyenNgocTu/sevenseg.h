...
*/
extern void SevenSeg_SendCommand(LPSPI_HandleType *pLPSPIHandler, uint8 address, uint8 command);

/**
* @brief  This function send command containing address and data to MAX7219 module.
*/
extern void SevenSeg_Init(LPSPI_HandleType *pLPSPIHandler);

/**
* @brief  This function send a string of data to 7-SEGMENT.
*/
extern void SevenSeg_PrintString(LPSPI_HandleType *pLPSPIHandler, uint8 *string, uint8 len);

/**
* @brief  This function turn off displaying screen.
*/
extern void SevenSeg_ClearDisplay(LPSPI_HandleType *pLPSPIHandler);

/**
* @brief  This function turn on displaying screen.
*/
extern void SevenSeg_SetDisplay(LPSPI_HandleType *pLPSPIHandler);
